...
mkdir build
cd build
cmake -DCMAKE_BUILD_TYPE=Release -DWITH_QT=ON -DWITH_OPENGL=ON -DWITH_GDAL=ON -D WITH_TBB=ON -DWITH_XINE=ON -DBUILD_EXAMPLES=ON -DENABLE_PRECOMPILED_HEADERS=OFF -DOPENCV_EXTRA_MODULES_PATH=../../opencv_contrib/modules ..
